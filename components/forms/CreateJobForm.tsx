...
export function CreateJobForm({
    ...
    const form = useForm<z.infer<typeof jobSchema>>({
        ...
        defaultValues: {
            ...
            listingDuration: 30,
            location: "",
            salaryFrom: 10000, // Changed from 0 to meet validation requirements
            salaryTo: 50000,   // Changed from 0 to meet validation requirements
        },
    });
    ...
    async function onSubmit(values: z.infer<typeof jobSchema>) {
        ...
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                // The form should automatically show field errors
                return;
            }
